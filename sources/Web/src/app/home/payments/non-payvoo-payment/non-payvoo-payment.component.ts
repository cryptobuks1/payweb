...
@Component({
  selector: 'app-non-payvoo-payment',
  templateUrl: './non-payvoo-payment.component.html',
  styleUrls: ['./non-payvoo-payment.component.scss']
})
export class NonPayvooPaymentComponent implements OnInit {
  ...
  joinUs() {
    ...
    this.router.navigate(['personal/downloadapp'])
    } else if(this.account_type == "business") {
      this.router.navigate(['business/downloadapp'])
    }
  }
}
