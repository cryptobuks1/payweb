...
@Component({
  selector: 'app-b-physcardsettings',
  templateUrl: './b-physcardsettings.component.html',
  styleUrls: ['./b-physcardsettings.component.scss']
})
export class BPhyscardsettingsComponent implements OnInit {
  ...
  onResend(){
    this.onRes = !this.onRes;
  }
  onSms(){
    $("#pinCode").modal("show")
  }
  onEmail(){
    $("#emailCode").modal("show")
  }
  onDone1(){
    this.onRes = false;
  }
